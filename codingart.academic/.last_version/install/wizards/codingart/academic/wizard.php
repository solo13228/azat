...
class SelectTemplateStep extends CSelectTemplateWizardStep
{
	...
	function ShowStep()
	{
		...
		$wizard->SetVar("templateID", "academic");
...
class SiteSettingsStep extends CSiteSettingsWizardStep
{
	function InitStep()
	{
		...
		$siteLogo = $this->GetFileContentImgSrc(WIZARD_SITE_PATH."include/company_name.php", "/bitrix/wizards/bitrix/academic/site/templates/academic/lang/".LANGUAGE_ID."/logo.gif");
		if (!file_exists(WIZARD_SITE_PATH."include/logo.gif"))
			$siteLogo = "/bitrix/wizards/bitrix/academic/site/templates/academic/lang/".LANGUAGE_ID."/logo.gif";
