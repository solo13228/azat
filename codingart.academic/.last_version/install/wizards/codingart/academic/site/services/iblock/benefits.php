...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/benefits.xml"; 
...
CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_1").'--,--NAME--#--*'.GetMessage("WZD_OPTION_2").'--,--PROPERTY_'.$arProperty["PAGE_LINK"].'--#--'.GetMessage("WZD_OPTION_3").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_4").'--;--'));  
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("BENEFITS_IBLOCK_ID" => $iblockID));
