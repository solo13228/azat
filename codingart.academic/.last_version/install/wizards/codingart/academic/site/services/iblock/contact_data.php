...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/contact_data.xml"; 
$iblockCode = "contact_data_".WIZARD_SITE_ID;
$iblockType = "content"; 
...
CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_1").'--,--NAME--#--*'.GetMessage("WZD_OPTION_2").'--,--PROPERTY_'.$arProperty["DESCRIP"].'--#--'.GetMessage("WZD_OPTION_3").'--,--PROPERTY_'.$arProperty["ICON"].'--#--'.GetMessage("WZD_OPTION_4").'--;--'));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("CONTACT_DATA_IBLOCK_ID" => $iblockID));
