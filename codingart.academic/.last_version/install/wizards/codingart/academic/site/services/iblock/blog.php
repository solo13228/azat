...
CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_1").'--,--NAME--#--*'.GetMessage("WZD_OPTION_2").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_3").'--,--TAGS--#--'.GetMessage("WZD_OPTION_4").'--;--edit6--#--'.GetMessage("WZD_OPTION_5").'--,--DETAIL_PICTURE--#--'.GetMessage("WZD_OPTION_6").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_7").'--;--'));
