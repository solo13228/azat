...
CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_1").'--,--NAME--#--*'.GetMessage("WZD_OPTION_2").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_3").'--,--PROPERTY_'.$arProperty["ADDRESS"].'--#--'.GetMessage("WZD_OPTION_4").'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_5").'--;--edit6--#--'.GetMessage("WZD_OPTION_6").'--,--DETAIL_PICTURE--#--'.GetMessage("WZD_OPTION_7").'--,--PROPERTY_'.$arProperty["SPEAKER_POSIT"].'--#--'.GetMessage("WZD_OPTION_8").'--,--PROPERTY_'.$arProperty["SPEAKER_NAME"].'--#--'.GetMessage("WZD_OPTION_9").'--,--PROPERTY_'.$arProperty["SPEAKER_PHOTO"].'--#--'.GetMessage("WZD_OPTION_10").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_11").'--;--'));  
