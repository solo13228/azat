...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/contact_requests.xml"; 
$iblockCode = "contact_requests_".WIZARD_SITE_ID;
$iblockType = "requests"; 
...
CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_1").'--,--DATE_CREATE--#--'.GetMessage("WZD_OPTION_2").'--,--NAME--#--*'.GetMessage("WZD_OPTION_3").'--,--PROPERTY_'.$arProperty["REQ_EMAIL"].'--#--'.GetMessage("WZD_OPTION_4").'--,--PROPERTY_'.$arProperty["REQ_MESS"].'--#--'.GetMessage("WZD_OPTION_5").'--;--'));  
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("CONTACT_REQUESTS_IBLOCK_ID" => $iblockID));
