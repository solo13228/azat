...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/courses.xml"; 
$iblockCode = "courses_".WIZARD_SITE_ID;
$iblockType = "content"; 
...
CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit5--#--'.GetMessage("WZD_OPTION_1").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_2").'--,--NAME--#--*'.GetMessage("WZD_OPTION_3").'--,--PROPERTY_'.$arProperty["SERVICES_ICON"].'--#--'.GetMessage("WZD_OPTION_4").'--;--edit6--#--Подробно--,--DETAIL_PICTURE--#--'.GetMessage("WZD_OPTION_5").'--,--PROPERTY_'.$arProperty["STUDENTS"].'--#--'.GetMessage("WZD_OPTION_6").'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_7").'--,--PROPERTY_'.$arProperty["DURATION"].'--#--'.GetMessage("WZD_OPTION_8").'--,--PROPERTY_'.$arProperty["CLASS_DURATION"].'--#--'.GetMessage("WZD_OPTION_9").'--,--PROPERTY_'.$arProperty["PRICE"].'--#--'.GetMessage("WZD_OPTION_10").'--,--PROPERTY_'.$arProperty["SKILL_LEVEL"].'--#--'.GetMessage("WZD_OPTION_11").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_12").'--;--')); 
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("COURSES_IBLOCK_ID" => $iblockID));
