...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/videoboard-block.xml"; 
$iblockCode = "videoboard-block_".WIZARD_SITE_ID;
$iblockType = "content"; 
...
CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_1").'--,--NAME--#--*'.GetMessage("WZD_OPTION_2").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_3").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_4").'--;--'));  
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("VIDEOBOARD-BLOCK_IBLOCK_ID" => $iblockID));
