...
CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_1").'--,--NAME--#--*'.GetMessage("WZD_OPTION_2").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_3").'--,--PROPERTY_'.$arProperty["POSER"].'--#--'.GetMessage("WZD_OPTION_4").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_5").'--;--'));  
