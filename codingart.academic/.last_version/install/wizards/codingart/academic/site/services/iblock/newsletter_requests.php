...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/newsletter_requests.xml"; 
$iblockCode = "newsletter_requests_".WIZARD_SITE_ID;
$iblockType = "requests"; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("NEWSLETTER_REQUESTS_IBLOCK_ID" => $iblockID));
