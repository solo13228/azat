	    ...
	    <div class="single-event mb-60">
	        <div class="event-img">
	            <a href="<?echo $arItem["DETAIL_PAGE_URL"]?>">
	                <img src="<?=$arItem["PREVIEW_PICTURE"]["SRC"]?>" alt="event" style="height: 246px; width: 100%;margin:0 auto;">
	        ...
	        <div class="event-content text-left">
	            ...
	            <div class="event-content-right">
	                <a class="default-btn" href="<?echo $arItem["DETAIL_PAGE_URL"]?>"><?=GetMessage("MOREINFO")?></a>
	            </div>
	        </div>
	    </div>
	    </div>	
