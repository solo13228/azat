...
<div class="reply-area">
	<h3 class="reply-h">Записаться на курс</h3>
...
<?=bitrix_sessid_post()?>
    ...
    <div class="col-md-12">
             ...
             <?=GetMessage("MFT_COURS")?><?if(empty($arParams["REQUIRED_FIELDS"]) || in_array("user_cours", $arParams["REQUIRED_FIELDS"])):?><span class="mf-req">*</span><?endif?>
      
        <input class="mbox" type="text" name="user_cours" value="<?echo $GLOBALS['krasn'];?>" readonly>
    </div>
<div class="col-md-12">
