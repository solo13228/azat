...
class SelectSiteStep extends CSelectSiteWizardStep
{
	function InitStep()
	{
		...
		$wizard->solutionName = "studycenter";
	}
}
...
class SelectTemplateStep extends CSelectTemplateWizardStep
{
	...
	function ShowStep()
	{
		...
		$wizard->SetVar("templateID", "studycenter");
...
class SiteSettingsStep extends CSiteSettingsWizardStep
{
	function InitStep()
	{
		...
		$siteLogo = $this->GetFileContentImgSrc(WIZARD_SITE_PATH."include/company_name.php", "/bitrix/wizards/bitrix/studycenter/site/templates/studycenter/lang/".LANGUAGE_ID."/logo.gif");
		if (!file_exists(WIZARD_SITE_PATH."include/logo.gif"))
			$siteLogo = "/bitrix/wizards/bitrix/studycenter/site/templates/studycenter/lang/".LANGUAGE_ID."/logo.gif";
			
		$wizard->SetDefaultVars(
			Array(
				"siteLogo" => $siteLogo,
				"sitePhone" => "+8 800 123 45 67", 
