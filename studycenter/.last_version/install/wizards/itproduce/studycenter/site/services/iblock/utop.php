...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/utop.xml"; 
$iblockCode = "utop_".WIZARD_SITE_ID;
$iblockType = "content"; 
...
CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("UTP_1").'--,--PROPERTY_'.$arProperty["TOPDESCR"].'--#--'.GetMessage("UTP_2").'--,--PREVIEW_PICTURE--#--'.GetMessage("UTP_3").'--,--NAME--#--*'.GetMessage("UTP_4").'--;--')); 
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("UTOP_IBLOCK_ID" => $iblockID));
