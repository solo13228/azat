...
$iblockCode = "blogs_".WIZARD_SITE_ID;
$iblockType = "content"; 
...
CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("BLG_1").'--,--ACTIVE--#--'.GetMessage("BLG_2").'--,--NAME--#--*'.GetMessage("BLG_3").'--,--PROPERTY_'.$arProperty["DATE"].'--#--'.GetMessage("BLG_4").'--,--TAGS--#--'.GetMessage("BLG_5").'--;--edit5--#--'.GetMessage("BLG_6").'--,--PREVIEW_PICTURE--#--'.GetMessage("BLG_7").'--,--PREVIEW_TEXT--#--'.GetMessage("BLG_8").'--;--edit6--#--'.GetMessage("BLG_9").'--,--DETAIL_PICTURE--#--'.GetMessage("BLG_10").'--,--DETAIL_TEXT--#--'.GetMessage("BLG_11").'--;--'));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("BLOGS_IBLOCK_ID" => $iblockID));
