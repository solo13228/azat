...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/classblock.xml"; 
$iblockCode = "classblock_".WIZARD_SITE_ID;
$iblockType = "content"; 
...
CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'cedit1--#--'.GetMessage("CLB_1").'--,--NAME--#--*'.GetMessage("CLB_2").'--,--PREVIEW_PICTURE--#--'.GetMessage("CLB_3").'--,--PREVIEW_TEXT--#--'.GetMessage("CLB_4").'--;--'));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("CLASSBLOCK_IBLOCK_ID" => $iblockID));
