...
CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'cedit1--#--'.GetMessage("EVE_1").'--,--NAME--#--*'.GetMessage("EVE_2").'--,--PROPERTY_'.$arProperty["DATE_EVENT"].'--#--'.GetMessage("EVE_3").'--,--PROPERTY_'.$arProperty["PLACE"].'--#--'.GetMessage("EVE_4").'--,--PROPERTY_'.$arProperty["ORGANIZER"].'--#--'.GetMessage("EVE_5").'--,--PROPERTY_'.$arProperty["PRICE"].'--#--'.GetMessage("EVE_6").'--,--PROPERTY_'.$arProperty["IMG"].'--#--'.GetMessage("EVE_7").'--;--cedit2--#--'.GetMessage("EVE_8").'--,--DETAIL_PICTURE--#--'.GetMessage("EVE_9").'--,--PROPERTY_'.$arProperty["PICONE"].'--#--'.GetMessage("EVE_10").'--,--PROPERTY_'.$arProperty["PICTWO"].'--#--'.GetMessage("EVE_11").'--,--PROPERTY_'.$arProperty["PICTHREE"].'--#--'.GetMessage("EVE_12").'--,--PROPERTY_'.$arProperty["PICFOUR"].'--#--'.GetMessage("EVE_13").'--,--DETAIL_TEXT--#--'.GetMessage("EVE_14").'--;--'));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("EVENTS_IBLOCK_ID" => $iblockID));
