...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/masonary.xml"; 
$iblockCode = "masonary_".WIZARD_SITE_ID;
$iblockType = "content"; 
...
CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'cedit10--#--'.GetMessage("MAS_1").'--,--NAME--#--*'.GetMessage("MAS_2").'--,--PREVIEW_PICTURE--#--'.GetMessage("MAS_3").'--,--PROPERTY_'.$arProperty["PHOTO1"].'--#--'.GetMessage("MAS_4").'--,--PROPERTY_'.$arProperty["PHOTO2"].'--#--'.GetMessage("MAS_5").'--,--PROPERTY_'.$arProperty["PHOTO3"].'--#--'.GetMessage("MAS_6").'--,--PROPERTY_'.$arProperty["PHOTO4"].'--#--'.GetMessage("MAS_7").'--,--PROPERTY_'.$arProperty["PHOTO5"].'--#--'.GetMessage("MAS_8").'--,--PROPERTY_'.$arProperty["PHOTO6"].'--#--'.GetMessage("MAS_9").'--,--PROPERTY_'.$arProperty["PHOTO7"].'--#--'.GetMessage("MAS_10").'--,--PROPERTY_'.$arProperty["PHOTO8"].'--#--'.GetMessage("MAS_11").'--,--PROPERTY_'.$arProperty["PHOTO9"].'--#--'.GetMessage("MAS_12").'--,--PROPERTY_'.$arProperty["PHOTO10"].'--#--'.GetMessage("MAS_13").'--;--')); 
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("MASONARY_IBLOCK_ID" => $iblockID));
