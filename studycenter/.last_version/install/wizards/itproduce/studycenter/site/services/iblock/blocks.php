...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/blocks.xml"; 
$iblockCode = "blocks_".WIZARD_SITE_ID;
$iblockType = "content"; 
...
CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'cedit1--#--'.GetMessage("BLK_1").'--,--NAME--#--*'.GetMessage("BLK_2").'--,--PROPERTY_'.$arProperty["OPISANIE"].'--#--'.GetMessage("BLK_3").'--,--PROPERTY_'.$arProperty["ICONS"].'--#--'.GetMessage("BLK_4").'--;--'));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("BLOCKS_IBLOCK_ID" => $iblockID));
