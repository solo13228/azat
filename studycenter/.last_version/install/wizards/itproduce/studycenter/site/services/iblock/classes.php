...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/classes.xml"; 
$iblockCode = "classes_".WIZARD_SITE_ID;
$iblockType = "content"; 
...
CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'cedit1--#--'.GetMessage("CLS_1").'--,--NAME--#--*'.GetMessage("CLS_2").'--,--PROPERTY_'.$arProperty["CLASS_SIZE"].'--#--'.GetMessage("CLS_3").'--,--PROPERTY_'.$arProperty["AGE"].'--#--'.GetMessage("CLS_4").'--,--PROPERTY_'.$arProperty["LEARNING_TIME"].'--#--'.GetMessage("CLS_5").'--,--PROPERTY_'.$arProperty["COURES_DURATION"].'--#--'.GetMessage("CLS_6").'--,--PROPERTY_'.$arProperty["PRICE"].'--#--'.GetMessage("CLS_7").'--,--PROPERTY_'.$arProperty["PRICE"].'--#--'.GetMessage("CLS_8").'--;--cedit2--#--'.GetMessage("CLS_9").'--,--PROPERTY_'.$arProperty["TEACHER_NAME"].'--#--'.GetMessage("CLS_10").'--,--PROPERTY_'.$arProperty["CLASS_NAME"].'--#--'.GetMessage("CLS_11").'--,--PROPERTY_'.$arProperty["TEACHER_PHOTO"].'--#--'.GetMessage("CLS_12").'--;--cedit3--#--'.GetMessage("CLS_13").'--,--DETAIL_TEXT--#--*'.GetMessage("CLS_14").'--;--'));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("CLASSES_IBLOCK_ID" => $iblockID));
