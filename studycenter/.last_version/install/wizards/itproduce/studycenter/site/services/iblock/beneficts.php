...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/beneficts.xml"; 
$iblockCode = "beneficts_".WIZARD_SITE_ID;
$iblockType = "content"; 
...
CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("BNF_1").'--,--NAME--#--*'.GetMessage("BNF_2").'--,--PREVIEW_PICTURE--#--'.GetMessage("BNF_3").'--,--PREVIEW_TEXT--#--'.GetMessage("BNF_4").'--;--'));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("BENEFICTS_IBLOCK_ID" => $iblockID));
