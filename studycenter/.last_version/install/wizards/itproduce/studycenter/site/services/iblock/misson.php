...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/misson.xml"; 
$iblockCode = "misson_".WIZARD_SITE_ID;
$iblockType = "content"; 
...
CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("MIS_1").'--,--NAME--#--*'.GetMessage("MIS_2").'--,--PREVIEW_PICTURE--#--'.GetMessage("MIS_3").'--,--PREVIEW_TEXT--#--'.GetMessage("MIS_4").'--;--')); 
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("MISSON_IBLOCK_ID" => $iblockID));
