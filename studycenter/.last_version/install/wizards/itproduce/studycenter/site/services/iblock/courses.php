...
CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'cedit1--#--'.GetMessage("CRS_1").'--,--NAME--#--*'.GetMessage("CRS_2").'--,--PREVIEW_PICTURE--#--'.GetMessage("CRS_3").'--,--PROPERTY_'.$arProperty["IMAGE"].'--#--'.GetMessage("CRS_4").'--,--PROPERTY_'.$arProperty["PHONE"].'--#--'.GetMessage("CRS_5").'--,--DETAIL_TEXT--#--'.GetMessage("CRS_6").'--;--'));
