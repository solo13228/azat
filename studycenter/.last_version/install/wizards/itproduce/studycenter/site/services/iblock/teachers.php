...
CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'cedit2--#--'.GetMessage("TEA_1").'--,--NAME--#--*'.GetMessage("TEA_2").'--,--PREVIEW_PICTURE--#--'.GetMessage("TEA_3").'--,--DETAIL_PICTURE--#--'.GetMessage("TEA_4").'--,--PROPERTY_'.$arProperty["POSITION"].'--#--'.GetMessage("TEA_5").'--,--PROPERTY_'.$arProperty["EDUCATION"].'--#--'.GetMessage("TEA_6").'--,--PROPERTY_'.$arProperty["BIRTHDAY"].'--#--'.GetMessage("TEA_7").'--,--PROPERTY_'.$arProperty["EXPERIANCE"].'--#--'.GetMessage("TEA_8").'--,--DETAIL_TEXT--#--'.GetMessage("TEA_9").'--;--cedit1--#--'.GetMessage("TEA_10").'--,--PROPERTY_'.$arProperty["TEACHING"].'--#--'.GetMessage("TEA_11").'--,--PROPERTY_'.$arProperty["SPEAKING"].'--#--'.GetMessage("TEA_12").'--,--PROPERTY_'.$arProperty["SUPPORT"].'--#--'.GetMessage("TEA_13").'--,--PROPERTY_'.$arProperty["WELL_BEING"].'--#--'.GetMessage("TEA_14").'--;--cedit3--#--'.GetMessage("TEA_15").'--,--PROPERTY_'.$arProperty["EMAIL"].'--#--'.GetMessage("TEA_16").'--,--PROPERTY_'.$arProperty["PHONE"].'--#--'.GetMessage("TEA_17").'--;--'));
