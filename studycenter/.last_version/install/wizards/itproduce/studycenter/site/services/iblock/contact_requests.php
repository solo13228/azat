...
CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'edit1--#--'.GetMessage("COR_1").'--,--DATE_CREATE--#--'.GetMessage("COR_2").'--,--NAME--#--*'.GetMessage("COR_3").'--,--PROPERTY_'.$arProperty["REQ_EMAIL"].'--#--'.GetMessage("COR_4").'--,--PROPERTY_'.$arProperty["REQ_MESS"].'--#--'.GetMessage("COR_5").'--;--'));
