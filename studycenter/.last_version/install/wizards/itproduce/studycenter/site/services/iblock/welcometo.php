...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/welcometo.xml"; 
$iblockCode = "welcometo_".WIZARD_SITE_ID;
$iblockType = "content"; 
...
CUserOptions::SetOption("form", "form_element_".$iblockID, array("tabs" => 'cedit1--#--'.GetMessage("WLC_1").'--,--NAME--#--*'.GetMessage("WLC_2").'--,--PREVIEW_PICTURE--#--'.GetMessage("WLC_3").'--,--PREVIEW_TEXT--#--'.GetMessage("WLC_4").'--;--')); 
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/iblock_id_link.php", array("WELCOMETO_IBLOCK_ID" => $iblockID));
