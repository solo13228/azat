...
.classes-section .classes-col .class-thumb .crt-btn {
    background: linear-gradient(180deg, #f37335, #f37335);
}
...
.newsletter-section .newsletter-sec {
    background: linear-gradient(90deg, #f37335, #f37335);
}
...
.schedule-page .schedule-content .schp-list li .mkd-info.bg-2 {
    background: linear-gradient(180deg, #159957, #1260a0);
}
...
.sidebar .widget-calendar .mdp-calendar table tbody td.active {
    background: linear-gradient(270deg, #f37335, #f37335);
    color: #fff;
}
...
.error-page .error-text .social-icons li a {
    background: linear-gradient(270deg, #159957, #1260a0);
}
...
.teacher-single-page .teacher-coly .social-icons li a:hover:before {
    background: linear-gradient(0deg, #f37335, #f37335);
}
...
.back-to-top {
    color: #fff;
    background-image: linear-gradient(180deg, #f37335, #f37335);
}
.back-to-top:hover {
    background-image: linear-gradient(210deg, #f37335, #f37335);
}
input[type="submit"]{
    color: #fff;
...
label.col-sm-4.col-xs-12.control-label.required
{
    color: #2b2b2b;
}
.mf-ok-text {
