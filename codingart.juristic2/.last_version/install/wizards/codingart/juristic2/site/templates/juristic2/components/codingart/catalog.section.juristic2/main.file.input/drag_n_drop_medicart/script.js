...
window.BlogBFileDialogUploader.prototype.Callback = function(files, uniqueID)
{
	...
	var inp = BX("new_upload");
	var inp_img = BX("new_upload_img");
	$(".upload_img_box").css("opacity","1");
	$("img.loading_gif").css("opacity","0");
	
  BX.adjust(inp, {props: {value: result.element_id}});
 BX.adjust(inp_img, {props: {src: result.element_url}});
