    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
			...
			<div class="row  justify-content-center">
				...
				<div class="col-xl-12 col-lg-12 input-container">
					<label><?=GetMessage('FORM_REV_COMENT')?></label>
					<textarea name="profile_coment" class="mt-2 mt-md-0 ym-record-keys" placeholder="<?=GetMessage('FORM_REV_COMENT')?>" required=""></textarea>
				</div>
