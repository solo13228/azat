  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle"><?=$arParams['FORM_TITLE']?></h5>
      ...
      <div class="modal-body">
			...
			<div class="row  justify-content-center">
				...
				<div class="col-xl-12 col-lg-12 input-container">
					<label><?=GetMessage('FORM_REV_PHONE')?><?if(empty($arParams["REQUIRED_FIELDS"]) || in_array('PHONE', $arParams["REQUIRED_FIELDS"])):?>*<?endif;?></label>
					<input name="profile_phone" type="tel" class="mt-2 mt-md-0 ym-record-keys" 
					placeholder="<?=GetMessage('FORM_REV_PHONE')?><?if(empty($arParams["REQUIRED_FIELDS"]) || in_array('PHONE', $arParams["REQUIRED_FIELDS"])):?>*<?endif;?>" 
