...
if (isset($arCurrentValues['VIEW_MODE']) && 'LIST' == $arCurrentValues['VIEW_MODE'])
{
	$arTemplateParameters['THIS_SID'] = array(
		'PARENT' => 'COUNT_ELEMENTS',
		'NAME' => GetMessage('THIS_SID_NAME'),
		'TYPE' => 'TEXT',
		'DEFAULT' => $_REQUEST["SECTION_ID"]
	);
	$arTemplateParameters['THIS_EID'] = array(
		'PARENT' => 'COUNT_ELEMENTS',
		'NAME' => GetMessage('THIS_EID_NAME'),
		'TYPE' => 'TEXT',
		'DEFAULT' => $_REQUEST["SECTION_ID"]
	);
}
