...
.main-header .header-top{
	background: rgba(38, 43, 62, 0.5);
}
.main-header .header-top .top-left li{
	color:#ffffff;
}
.main-header .header-top .top-left a.navsearch-button i {
    color: #C9B38C;
}
...
.services-block .icon-box span.icon svg path, .services-block .icon-box span.icon svg rect{
    fill: #C9B38C;
}
...
.team-block .image .overlay-box:before{
	background-image: -ms-linear-gradient(top, rgba(255,255,255,0) 0%, #C9B38C 100%);
	background-image: -moz-linear-gradient(top, rgba(255,255,255,0) 0%, #C9B38C 100%);
	background-image: -o-linear-gradient(top, rgba(255,255,255,0) 0%, #C9B38C 100%);
	background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgba(255,255,255,0)), color-stop(100, #C9B38C));
	background-image: -webkit-linear-gradient(top, rgba(255,255,255,0) 0%, #C9B38C 100%);
	background-image: linear-gradient(to bottom, rgba(255,255,255,0) 0%, #C9B38C 100%);
}
...
.booking-section .video-column .inner-column .green-layer:before{
	background:url(/bitrix/templates/juristic2/../images/icons/video-icon-1.png) no-repeat;
}
.booking-section .video-column .inner-column .green-layer:after{
	background:url(/bitrix/templates/juristic2/../images/icons/video-icon-2.png) no-repeat;
}
.video-box .image{
...
.schedule-widget .overlay-box{
	background-image: -ms-linear-gradient(top, rgba(255,255,255,0) 0%, #556080 100%);
	background-image: -moz-linear-gradient(top, rgba(255,255,255,0) 0%, #556080 100%);
	background-image: -o-linear-gradient(top, rgba(255,255,255,0) 0%, #556080 100%);
	background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, rgba(255,255,255,0)), color-stop(100, #556080));
	background-image: -webkit-linear-gradient(top, rgba(255,255,255,0) 0%, #556080 100%);
	background-image: linear-gradient(to bottom, rgba(255,255,255,0) 0%, #556080 100%);
}
.schedule-widget h3{
	color:#ffffff;
}
...
.sidebar .widget.catalog_list ul li ul a:hover {
    background-image: linear-gradient(80deg,#C9B38C38 0%,#55608000 100%)  !important;
}
.sidebar .widget.catalog_list ul li ul a.hover {
...
.sidebar .widget.catalog_list ul li a.lvl-01:hover {
    /* background-image: linear-gradient(-58deg,#556080 0%,#C9B38C 100%); */
}
...
.sidebar .widget.catalog_list ul li a.lvl-03 {
	background: #C9B38C; opacity:0.7; color:#fff;
}
...
.banner-section .banner-carousel .slide-item:before{
    background-image: linear-gradient(-100deg, rgba(0, 0, 0, 0) 30%, #C9B38C 79%);
}
.banner-section .banner-carousel .slide-item:after{
    background-image: linear-gradient(100deg, rgba(0, 0, 0, 0) 0%, #C9B38C 0%);
}
...
.featured-block .icon-box svg.list_icon use, .featured-block .icon-box svg path {
    fill:#556080;
}
...
.main-header .header-top .top-left li span.icon, .main-header .header-top .top-left li .icon {
    color: #C9B38C !important;
}
.owl-dots .owl-dot{
	background-color: #C9B38C !important;
}
.main-header .header-top .top-left a.btn{
	background: #C9B38C;
}
.main-header .header-top .top-left a.btn:hover{
	background: #556080;
}
.all_page header.elementskit-header{
    background: #556080;
}
.social-box a.icon {
    color: #ffffff;
...
.bx-breadcrumb .bx-breadcrumb-item:not(.s) span {
    color: #C9B38C;
}
section.adv_main_page .featured-block .inner-box:hover {
    background: #C9B38C;
}
.testimonial-block .quote-icon svg path {
    fill: #C9B38C;
}
.services-section-two .services-block.tab-btn .inner-box.active {
    background: #556080 !important;
}
.elementskit-header.fixed .header-upper {
    background: #55608091;
}
.services-section-two .services-block.tab-btn .inner-box:hover {
    background: #556080;
    color: #fff;
}
.o-nas .featured-list svg path {
    fill: #C9B38C;
}
...
.contact-address .text, .contact-address .text a {
    color: rgba(34,34,34,0.70) !important;
    font-family: 'Muli', sans-serif !important;
}
.main_page .container-fluid.o-nas-block .outer-section .right-column {
    background: #556080 !important;
}
.sidebar .widget.catalog_list ul li.active_ids a.lvl-01, .sidebar .widget.catalog_list ul li a.lvl-01.hover {
    background: #C9B38C;
    color: #ffffff;
    border-top: 1px solid #f2ecec;
}
.sidebar .widget.catalog_list ul li.active_ids  i[lvl_data="1"], .sidebar .widget.catalog_list li.lvl-01.hover i.icon {
    color: #fff;
}
