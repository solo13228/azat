...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/certificates.xml"; 
$iblockCode = "certificates_".WIZARD_SITE_ID;
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/inc/iblock_id_link.php", array("CERTIFICATES_IBLOCK_ID" => $iblockID));
