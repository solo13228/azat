...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/requests_7.xml"; 
$iblockCode = "requests_7_".WIZARD_SITE_ID; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/inc/iblock_id_link.php", array("REQUESTS_7_IBLOCK_ID" => $iblockID));
?>
