...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/icons_svg.xml"; 
$iblockCode = "icons_svg_".WIZARD_SITE_ID; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/inc/iblock_id_link.php", array("ICONS_SVG_IBLOCK_ID" => $iblockID));
?>
