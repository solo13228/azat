...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/requests_4.xml"; 
$iblockCode = "requests_4_".WIZARD_SITE_ID; 
$iblockType = "requests_juristic2";  
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/inc/feedbsck.php", array("REQUESTS_4_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/inc/iblock_id_link.php", array("REQUESTS_4_IBLOCK_ID" => $iblockID));

CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("REQUESTS_4_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/specialists/index.php", array("REQUESTS_4_IBLOCK_ID" => $iblockID));
?>
