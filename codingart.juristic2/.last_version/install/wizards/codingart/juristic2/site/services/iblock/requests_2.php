...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/requests_2.xml"; 
$iblockCode = "requests_2_".WIZARD_SITE_ID; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/inc/iblock_id_link.php", array("REQUESTS_2_IBLOCK_ID" => $iblockID));
?>
