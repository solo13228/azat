...
$iblockCode = "price_".WIZARD_SITE_ID;
$iblockType = "catalog_juristic2"; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/inc/iblock_id_link.php", array("PRICE_IBLOCK_ID" => $iblockID));
