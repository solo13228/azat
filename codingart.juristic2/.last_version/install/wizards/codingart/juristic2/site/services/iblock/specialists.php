...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/specialists.xml"; 
$iblockCode = "specialists_".WIZARD_SITE_ID; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/inc/iblock_id_link.php", array("SPECIALISTS_IBLOCK_ID" => $iblockID));
