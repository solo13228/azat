...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/new_blog.xml"; 
$iblockCode = "new_blog_".WIZARD_SITE_ID; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/inc/iblock_id_link.php", array("NEW_BLOG_IBLOCK_ID" => $iblockID));
?>
