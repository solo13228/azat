...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/questions_and_answers.xml"; 
$iblockCode = "questions_and_answers_".WIZARD_SITE_ID; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/inc/iblock_id_link.php", array("QUESTIONS_IBLOCK_ID" => $iblockID));
