...
*/
	...
	WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."price/sale/", Array("SITE_DIR" => WIZARD_SITE_DIR));
	...
	WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."specialists/", Array("SITE_DIR" => WIZARD_SITE_DIR));
...
$arNewUrlRewrite = array(
  array (
    'CONDITION' => '#^'.WIZARD_SITE_DIR.'specialists/#',
    'RULE' => '',
    'ID' => '',
    'PATH' => WIZARD_SITE_DIR.'specialists/index.php',
  ),
  array (    'CONDITION' => '#^'.WIZARD_SITE_DIR.'price/sale/#',
    'RULE' => '',
    'ID' => 'codingart:news.juristic2',
    'PATH' => WIZARD_SITE_DIR.'price/sale/index.php',
  ),
  array (
