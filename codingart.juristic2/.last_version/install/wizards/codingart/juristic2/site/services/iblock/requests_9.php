...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/requests_9.xml"; 
$iblockCode = "requests_9_".WIZARD_SITE_ID; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/inc/iblock_id_link.php", array("REQUESTS_9_IBLOCK_ID" => $iblockID));
?>
